                ...
                <div class="container mt-5">
                    ...
                    <table class="table table-bordered" border="5px">
                        ...
                        <tbody>
                            ...
                            $rs=mysqli_query($con,"select * from bkapt");
                            while($a=mysqli_fetch_array($rs))
                            {
                                ...
                                echo "<td>".$a[8]."</td>";
                                echo "<td>".$a[9]."</td>";
                                echo "<td><a href='aptupdate.php?aid=".$a[0]."' class='update-btn'>Update</a>
                                <a href='aptdelete.php?aid=".$a[0]."' class='delete-btn'>Delete</a></td>";
                                echo "</tr>";
                            }
                            ?>
                        </tbody>
