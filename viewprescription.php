...
<style>
        body {
            background-image: url('image/pres.jpg'); /* Replace 'your_background_image.jpg' with the path to your image */
                ...
                <div class="container mt-5">
                    ...
                    <table class="table table-bordered" border="5px">
                        ...
                        <tbody>
                            ...
                            $rs=mysqli_query($con,"select * from prescriptions");
                            while($a=mysqli_fetch_array($rs))
                            {
                                ...
                                echo "<td><a href='preupdate.php?prescription_id=".$a[0]."'class='update-btn'>Update</a>
                                <a href='predelete.php?prescription_id=".$a[0]."'class='delete-btn'>Delete</a></td>";
                                echo "</tr>";
                            }
                            ?>
                        </tbody>
