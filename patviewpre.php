        ...
        <div class="row">
            ...
            <div class="text-center"> <!-- Centering div -->
                    ...
                    if ($_SERVER["REQUEST_METHOD"] == "POST") {
                        ...
                        $query_pre = "SELECT * FROM prescriptions WHERE id = '$patient_id'";
                        ...
                        if ($result_pre) {
                            if (mysqli_num_rows($result_pre) > 0) {
                                ...
                                while ($row_pre = mysqli_fetch_assoc($result_pre)) {
                                    echo '<tr>';
                                    echo '<td>' . $row_pre['prescription_id'] . '</td>';
                                    echo '<td>' . $row_pre['id'] . '</td>';
                                    echo '<td>' . $row_pre['pfname'] . '</td>';
                                    echo '<td>' . $row_pre['plname'] . '</td>';
                                    echo '<td>' . $row_pre['doctorName'] . '</td>';
                                    echo '<td>' . $row_pre['medication'] . '</td>';
                                    echo '<td>' . $row_pre['notes'] . '</td>';
                                    echo '</tr>';
                                }
                                ...
                                echo "<p>No prescription found for the given patient ID.</p>";
                            }
                        } else {
                            echo "<p>Error fetching prescription data: " . mysqli_error($con) . "</p>";
                        }
