...
<head>
  ...
  <link href="https://cdn.jsdelivr.net/npm/bootstrap@5.0.2/dist/css/bootstrap.min.css" rel="stylesheet"
    ...
    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.0.0/css/all.min.css"
        ...
        <style>
        body {
            background-image: url('image/pat.jpg');
                ...
                <div class="container mt-5">
                    ...
                    <table class="table table-bordered" border="5px">
                        ...
                        <tbody>
                            ...
                            $rs=mysqli_query($con,"select * from adpat");
                            while($a=mysqli_fetch_array($rs))
                            {
                                ...
                                echo "<td><a href='patupdate.php?id=".$a[0]."'class='update-btn'>Update</a>
                                <a href='patdelete.php?id=".$a[0]."'class='delete-btn'>Delete</a></td>";
                                echo "</tr>";
                            }
                            ?>
                        </tbody>
